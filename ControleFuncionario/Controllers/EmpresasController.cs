...
namespace ControleFuncionario.Controllers
{
    public class EmpresasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmpresaId,Cnpj,NomeEmpresa")] Empresa empresa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmpresaId,Cnpj,NomeEmpresa")] Empresa empresa)
        {
